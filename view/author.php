...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">BLOGS /</span> AUTHORS POST</h4>
    </div>
...
<div class="box-container">
   ...
   <?php
      $select_posts = $bdd->prepare("SELECT * FROM `posts` WHERE name = ? and status = ?");
   ...
   <form class="box" method="post">
      ...
      <div class="post-admin">
         ...
         <div>
            <a href="author.php?author=<?= $fetch_posts['name']; ?>"><?= $fetch_posts['name']; ?></a>
